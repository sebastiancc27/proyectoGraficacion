...
var municion = preload("res://Escenas/Municion/proyectil_mg.tscn")

@onready var timer = $Velocidad_disparo
var velocidad_disparo = 0.1
...
func _process(delta):
	...
	$VBoxContainer/HBoxContainer/Label.text = str("Daño: ", Global.daño_proyectil_mg)
...
func _on_subir_nivel_pressed():
	if Global.cash >= subir_nivel:
		nivel_torre += 1
		Global.daño_proyectil_mg = Global.daño_proyectil_mg * 2
		Global.cash -= subir_nivel
		$area/area_vision.shape.radius += 10
